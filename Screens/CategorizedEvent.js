...
import { ActivityIndicator, Divider, Paragraph, Title } from "react-native-paper";
...
const CategorizedEvent = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    ...
    activeOpacity={0.6}
     ...
     >
       <MaterialCommunityIcons name={item.icon} size={18} color={Constants.background} style={{marginRight:8}}/>
