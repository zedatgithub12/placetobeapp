...
const ForgotPass = ({navigation}) => {
  ...
  const ResetPassword=()=>{
   ...
   if(email == 0){
    setError(true);
    setErrorMessage("Please enter you email address or username associated with your account");
    setSubmit(false);
   }
   else {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Reset Password</Text>
       <Caption style={styles.caption}>Enter your email address or username associated with your account in the field below</Caption>
      ...
      <TouchableOpacity
       ...
       activeOpacity={0.7} style={styles.sendBtn}>
        {submit ? (
      ...
      {succeed ? (
        <View style={styles.successContainer}>
          <Text style={styles.successText}>
            Successfully sent reset link to email address associated with your account open your email and set new
            password!
          </Text>
